...
#define INSN_load8() INSN_EMIT_macro_opcode(9)
#define INSN_or() INSN_EMIT_macro_opcode(10)
#define INSN_and() INSN_EMIT_macro_opcode(11)
#define INSN_xor() INSN_EMIT_macro_opcode(12)
#define INSN_add() INSN_EMIT_macro_opcode(13)
#define INSN_add_o() INSN_EMIT_macro_opcode(14)
#define INSN_sub_o() INSN_EMIT_macro_opcode(15)
#define INSN_mul_o() INSN_EMIT_macro_opcode(16)
#define INSN_lshift() INSN_EMIT_macro_opcode(17)
#define INSN_rshift() INSN_EMIT_macro_opcode(18)
#define INSN_urshift() INSN_EMIT_macro_opcode(19)
#define INSN_cmpeq() INSN_EMIT_macro_opcode(20)
#define INSN_cmplt() INSN_EMIT_macro_opcode(21)
#define INSN_cmpltu() INSN_EMIT_macro_opcode(22)
#define INSN_settos(arg1) (code = psyco_insn_settos(code, arg1))
EXTERNFN code_t* psyco_insn_settos(code_t* code, word_t arg1);
...
#define INSN_flag_push() INSN_EMIT_macro_opcode(44)
#define INSN_cmpz() INSN_EMIT_macro_opcode(45)
...
#define INSN_store1() INSN_EMIT_macro_opcode(51)
#define INSN_store2() INSN_EMIT_macro_opcode(52)
#define INSN_store4() INSN_EMIT_macro_opcode(53)
#define INSN_store8() INSN_EMIT_macro_opcode(54)
#define INSN_incref() INSN_EMIT_macro_opcode(55)
#define INSN_decref() INSN_EMIT_macro_opcode(56)
#define INSN_decrefnz(arg1) (code = psyco_insn_decrefnz(code, arg1))
EXTERNFN code_t* psyco_insn_decrefnz(code_t* code, word_t** arg1);
#define INSN_exitframe() INSN_EMIT_macro_opcode(58)
#define INSN_ret(arg1) (code = psyco_insn_ret(code, arg1))
EXTERNFN code_t* psyco_insn_ret(code_t* code, word_t arg1);
#define INSN_retval() INSN_EMIT_macro_opcode(62)
#define INSN_pushretval() INSN_EMIT_macro_opcode(63)
#define INSN_pyenter(arg1) (code = psyco_insn_pyenter(code, arg1))
EXTERNFN code_t* psyco_insn_pyenter(code_t* code, word_t** arg1);
#define INSN_pyleave() INSN_EMIT_macro_opcode(65)
