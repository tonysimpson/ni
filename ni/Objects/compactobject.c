...
{
    /*** Issue ## compact object is broken
     *
     * Fix by writing better behaved version that
     * emulates __dict__ or __slots__ properly.
     *
     * This version breaks inheritance for objects
     * with another __slots__ parent
     */
