...
To install from the binaries, be sure to download the version of Psyco that corresponds to your Python version.  Binary released are at \url{http://sourceforge.net/project/showfiles.php?group_id=41036}.  The following pre-compiled versions are currently distributed:
