...
\warning{The Linux binaries of Psyco 1.1 have been compiled for the recent \file{glibc-2.3}, which means that they will not work on what is currently still most systems! In the future I may switch back to \file{glibc-2.2}, or I may stop releasing Linux binaries altogether because it is incredibly easy to compile from the source (see section \ref{sources} --- you don't need to be root to do that).} Also note that at least some versions of Psyco have been successfully used on other PC Unixes like FreeBSD.
...
\begin{tableiii}{l|l|l}{filenq}{File name}{Python versions}{Well-tested with}
  ...
  \lineiii{ psyco-x.y-OS-2.3     }{2.3 and up}             {2.3}
\end{tableiii}
