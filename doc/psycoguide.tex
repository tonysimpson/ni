...
\begin{tableii}{l|l}{filenq}{File name}{Python version}
  \lineii{ psyco-x.y-OS-2.1     }{2.1 or any 2.1.x}
  \lineii{ psyco-x.y-OS-2.2.0-1 }{2.2 older than 2.2.2}
  \lineii{ psyco-x.y-OS-2.2.2   }{2.2.2 and up}
  \lineii{ psyco-x.y-OS-2.3     }{2.3}
\end{tableii}
