...
You should get the source code from its most current Subversion version at \url{http://codespeak.net/svn/psyco/dist/}.  (The command is ``svn co http://codespeak.net/svn/psyco/dist/ psyco-dist``)
