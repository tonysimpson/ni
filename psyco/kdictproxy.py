...
getslot_getter = compact.__dict__['__getslot__'].__get__
members_getter = compact.__dict__['__members__'].__get__
...
class compactdictproxy(DictMixin):
    ...
    def __init__(self, ko):
        ...
        self.__getitem__ = getslot_getter(ko)

    def __setitem__(self, key, value):
        setattr(self._ko, key, value)

    def __delitem__(self, key):
        try:
            delattr(self._ko, key)
        except AttributeError:
            raise KeyError, key

    def keys(self):
        return members_getter(self._ko)
